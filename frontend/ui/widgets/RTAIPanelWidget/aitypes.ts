...
export type WaveUIMessage = UIMessage<unknown, WaveUIDataTypes, Record<string, never>>;
export type WaveUIMessagePart = UIMessagePart<WaveUIDataTypes, Record<string, never>>;
