...
export const terminalSettingsCopy: LocalizedCopy<TerminalSettingsCopy> = {
  ...
  ru: {
    ...
    adjustScrollbackTitle: 'Настроить scrollback',
    ...
    cursorBlinkDescription:
      'Настройка мигания хранится в runtime, но xterm всё равно выключает мигание для завершённых и упавших сессий.',
    cursorStyleBar: 'Полоса',
    cursorStyleBlock: 'Блок',
    cursorStyleDescription:
      'Форма курсора задаётся через backend-owned contract и применяется к живым xterm sessions.',
    ...
    currentLineHeightDescription:
      'Высота строки управляет вертикальной плотностью xterm и применяется сразу ко всем живым terminal widgets.',
    currentLineHeightTitle: 'Текущая высота строки',
    currentScrollbackDescription:
      'Scrollback ограничивает объём буфера xterm и тоже идёт через runtime-owned contract.',
    currentScrollbackTitle: 'Текущий scrollback',
    defaultStateDescription: 'Эти настройки терминала теперь backed by shared runtime contract.',
    decreaseFontSizeAria: 'Уменьшить размер шрифта терминала',
    decreaseLineHeightAria: 'Уменьшить высоту строки терминала',
    decreaseScrollbackAria: 'Уменьшить scrollback терминала',
    ...
    increaseScrollbackAria: 'Увеличить scrollback терминала',
    loading: 'Загрузка...',
    ...
    resetScrollbackAria: 'Сбросить scrollback терминала',
    resetThemeModeAria: 'Сбросить режим темы терминала',
    resetTitle: 'Сбросить настройки терминала',
    resetDescription:
      'Одно действие возвращает runtime-owned базу терминала для типографики, палитры, scrollback и поведения курсора.',
    sectionDescription:
      'Runtime-owned настройки терминала по умолчанию. Они хранятся в backend state и применяются ко всем живым terminal widgets в текущем shell.',
    ...
    themeModeDescription:
      'Адаптивный режим следует текущему shell chrome, а контрастный принудительно включает более контрастную палитру терминала.',
