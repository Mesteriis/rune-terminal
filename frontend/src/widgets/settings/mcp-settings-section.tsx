...
const mcpSettingsCopy: Record<AppLocale, MCPSettingsCopy> = {
  ...
  ru: {
    ...
    description:
      'Подключение внешних MCP выполняется явно: зарегистрируйте адрес, затем вручную запускайте, останавливайте или включайте сервер.',
    disable: 'Выключить',
    disabledCount: (count) => `${count} выключено`,
    disabledState: 'выключен',
    edit: 'Изменить',
    enable: 'Включить',
    endpointAria: 'URL MCP-сервера',
    errorControl: (action) => `Не удалось выполнить ${action} для MCP-сервера`,
    errorDelete: 'Не удалось удалить MCP-сервер',
    errorDuplicateHeader: (name) => `Повторяющийся заголовок: ${name}`,
    errorHeaderDuplicateAuth: (name) => `${name} уже задан в заголовках. Уберите один из дублей.`,
    errorHeaderFormat: 'Строки заголовков должны быть в формате `Name: value`.',
    errorHeaderName: 'Имена заголовков не должны быть пустыми.',
    errorLoadDetails: 'Не удалось загрузить детали MCP-сервера',
    errorLoadServers: 'Не удалось загрузить MCP-серверы',
    errorLoadTemplates: 'Не удалось загрузить шаблоны MCP',
    errorProbe: 'Не удалось проверить MCP-сервер',
    errorSave: 'Не удалось сохранить MCP-сервер',
    filterAria: 'Фильтр MCP-серверов',
    filterPlaceholder: 'Фильтр зарегистрированных MCP-серверов',
    headersAria: 'Заголовки MCP-запроса',
    headersDescription:
      'Заголовки сохраняются в локальном реестре MCP. Данные из шаблона добавляются перед проверкой или регистрацией.',
    headersPlaceholder: 'Необязательные заголовки, по одному на строку: Authorization: Bearer ...',
    idAria: 'ID MCP-сервера',
    loadingServers: 'Загрузка MCP-серверов…',
    loadingTemplates: 'Загрузка шаблонов MCP…',
    localDescription: 'Локальный процессный сервер управляется подсистемой плагинов.',
    noFilterMatches: 'Нет MCP-серверов по текущему фильтру.',
    noServers: 'MCP-серверы пока не зарегистрированы.',
    optionalSecret: 'Необязательный секрет авторизации',
    probePrefix: 'Проверка',
    refresh: 'Обновить',
    refreshing: 'Обновление…',
    register: 'Зарегистрировать MCP-сервер',
    registeredCount: (count) => `${count} зарегистрировано`,
    registeredServer: (serverID) => `${serverID} зарегистрирован. Запустите его перед использованием.`,
    registering: 'Регистрация…',
    remoteDescriptionFallback: 'Адрес удалённого сервера пока не получен.',
    restart: 'Перезапустить',
    saveAria: 'Зарегистрировать MCP-сервер',
    saveChanges: 'Сохранить изменения',
    saveChangesAria: 'Сохранить изменения MCP-сервера',
    savedServer: (serverID) => `Сохранен ${serverID}.`,
    saving: 'Сохранение…',
    start: 'Запустить',
    stop: 'Остановить',
    templateDescription:
      'Загрузите шаблон, чтобы заполнить адрес и данные авторизации. Регистрация всё равно выполняется вручную.',
    templateLoaded: (name) => `Шаблон ${name} загружен.`,
    templateSecretAria: 'Секрет шаблона MCP',
    templatesTitle: 'Шаблоны подключения',
    testAria: 'Проверить MCP-сервер',
    testing: 'Проверка…',
    title: 'MCP-серверы',
