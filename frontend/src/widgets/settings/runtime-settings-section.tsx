...
const runtimeSettingsCopy: Record<AppLocale, RuntimeSettingsCopy> = {
  ...
  ru: {
    autoPreview: 'Автозаголовок',
    browserBadge: 'Браузер',
    debugModeCurrentState: 'Текущее состояние отладки AI',
    debugModeHint:
      'Когда режим выключен, панель AI скрывает отладку. Когда включён, режим отладки доступен в истории.',
    debugModeOptionDisabledLabel: 'Скрыт',
    debugModeOptionEnabledLabel: 'Включён',
    debugModeSectionDescription: 'Общие настройки управляют доступностью режима отладки AI.',
    debugModeSectionTitle: 'Отладка AI',
    debugModeStatusDisabled: 'Выключен',
    debugModeStatusEnabled: 'Включён',
    desktopBadge: 'Приложение',
    currentRule: 'Текущее правило',
    currentRuntime: 'Текущий запуск',
    currentShellTransport: 'Среда запуска',
    currentMode: 'Текущий режим',
    customTitlePlaceholder: 'Ops Shell',
    customTitleTextboxLabel: 'Пользовательский заголовок окна',
    currentLanguage: 'Текущий язык',
    generalLanguageDescription: 'Язык хранится в общих настройках и применяется сразу.',
    homeDirectory: 'Домашняя директория',
    languageChangesHint: 'Смена языка применяется сразу и не требует перезапуска приложения.',
    languageSectionDescription: 'Активная оболочка использует один общий язык интерфейса.',
    languageSectionTitle: 'Язык',
    loading: 'Загрузка…',
    repositoryRoot: 'Корень репозитория',
    resetToAuto: 'Сбросить в авто',
    refresh: 'Обновить',
    runtimeLifecycleDescription:
      'Режим закрытия определяет, завершать процесс вместе с окном или оставлять его запущенным.',
    runtimeLifecycleTitle: 'Закрытие приложения',
    runtimeSectionDescription: 'Текущие сведения о запуске, которые использует основная оболочка.',
    runtimeSectionTitle: 'Текущий запуск',
    saveCustomTitle: 'Сохранить заголовок',
    shellLanguage: 'Язык интерфейса',
    shellTheme: 'Тема интерфейса',
    splitBrowserLoop: 'Браузерный режим разработки',
    themeChangesHint: 'Смена темы сразу обновляет оформление приложения.',
    themeDarkDescription: 'Всегда использовать тёмную тему независимо от настроек ОС.',
    themeDarkLabel: 'Тёмная',
    themeLightDescription: 'Всегда использовать светлую тему независимо от настроек ОС.',
    themeLightLabel: 'Светлая',
    themeResolvedDark: 'Применено: тёмная',
    themeResolvedLight: 'Применено: светлая',
    themeSectionDescription: 'Оформление приложения управляется общей настройкой темы.',
    themeSectionTitle: 'Тема',
    themeSystemDescription: 'Следовать системной цветовой схеме.',
    themeSystemLabel: 'Системная',
    transport: 'Транспорт',
    unavailable: 'Недоступно',
    windowTitleAutoDescription: 'Автозаголовок следует за названием активной рабочей области.',
    windowTitleAutoOptionDescription: 'Использовать название активной рабочей области и подпись продукта.',
    windowTitleCustomDescription:
      'Закреплённый заголовок сохраняется до ручного сброса в автоматический режим.',
    windowTitleCustomOptionDescription: 'Закрепить явный заголовок окна до сброса.',
    windowTitleDescription:
      'Заголовок окна может следовать за активной рабочей областью или быть закреплён вручную.',
    windowTitleMode: 'Режим заголовка окна',
    windowTitleTitle: 'Заголовок окна',
    watcherModeHintDesktop: 'Изменения сразу влияют на поведение закрытия окна в приложении.',
    watcherModeHintBrowser:
      'В браузерном режиме разработки этот контроль доступен только для чтения. Откройте приложение, чтобы сохранить изменение.',
    watcherModeLabelEphemeral: 'Временный',
    watcherModeLabelPersistent: 'Постоянный',
    watcherModeOptionEphemeralDescription:
      'Окно приложения завершает процесс при закрытии после проверки активных задач.',
    watcherModeOptionEphemeralLabel: 'Временный процесс',
    watcherModeOptionPersistentDescription: 'Окно можно закрыть без остановки процесса.',
    watcherModeOptionPersistentLabel: 'Постоянный процесс',
    watcherModeRadioLabel: 'Поведение при закрытии',
    watcherModeShutdownEphemeral: 'Закрытие окна останавливает процесс после проверки активных задач.',
    watcherModeShutdownPersistent: 'Закрытие окна отсоединяется от процесса и оставляет его запущенным.',
    watcherModeTransportDesktop: 'Приложение',
  },
  'zh-CN': {
    autoPreview: '自动预览',
    browserBadge: '浏览器',
