...
export const terminalWidgetHeaderActionGroupStyle: React.CSSProperties = {
  display: 'inline-flex',
  alignItems: 'center',
  gap: '0.24rem',
  padding: '2px',
...
export const terminalWidgetSessionTabStyle: React.CSSProperties = {
  display: 'inline-flex',
  alignItems: 'stretch',
  minHeight: '30px',
...
export const terminalWidgetSessionShellBadgeStyle: React.CSSProperties = {
  flex: '0 0 auto',
  padding: '0.12rem 0.28rem',
  border:
    '1px solid color-mix(in srgb, var(--runa-terminal-surface-border, var(--color-border-subtle)) 42%, transparent)',
  borderRadius: 'var(--radius-sm)',
  background:
...
export const terminalWidgetSessionCloseButtonStyle: React.CSSProperties = {
  ['--runa-ui-bg' as string]: 'transparent',
  ['--runa-ui-border' as string]: 'transparent',
  ['--runa-ui-color' as string]: 'inherit',
  width: '24px',
  minWidth: '24px',
  minHeight: '28px',
  height: 'auto',
  ...
  WebkitBackdropFilter: 'none',
  borderLeft:
    '1px solid color-mix(in srgb, var(--runa-terminal-surface-border, var(--color-border-subtle)) 34%, transparent)',
}
