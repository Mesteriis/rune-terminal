...
func NewHandler(runtime *app.Runtime, authToken string) http.Handler {
	...
	mux.HandleFunc("GET /api/v1/terminal/shells", api.handleTerminalShells)
	mux.HandleFunc("GET /api/v1/terminal/sessions", api.handleTerminalSessionCatalog)
	...
	mux.HandleFunc("GET /api/v1/settings/locale", api.handleLocaleSettings)
	mux.HandleFunc("PUT /api/v1/settings/locale", api.handleUpdateLocaleSettings)
